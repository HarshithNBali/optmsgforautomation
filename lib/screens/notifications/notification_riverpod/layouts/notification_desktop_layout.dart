...
class NotificationDesktopLayout extends StatelessWidget {
  final NotificationState state;
  final NotificationNotifier notifier;
  final ScrollController scrollController;

  const NotificationDesktopLayout({
    super.key,
    required this.state,
  ...
  bool get _canShowToggle => true; // Always show on desktop
      ...
      child: NotificationItem(
        ...
        onTap: () {
          if (kIsWeb) {
            ...
            if (isShift) {
              final anchor = state.lastClickedIndex >= 0
